...
# classifier_train_csv='/data/duongdb/FH_OCT_08172021/FH_OCTs_label_train_input.csv' # !
# jsonname=dataset_eyepos_FH.json

classifier_train_csv='/data/duongdb/FH_OCT_08172021/FH_OCTs_label_train_input_driving.csv' # ! driving label class
...
do 
  ...
  do 
  outdir=$datapath/Classify/Tf$resolution'RmFold'$fold'+EyePos+Driving' # Driving FH
