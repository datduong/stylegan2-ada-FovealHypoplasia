...
metric_defaults = EasyDict([(args.name, args) for args in [
    ...
    EasyDict(name='fid350_full',     class_name='metrics.frechet_inception_distance.FID', max_reals=None, num_fakes=350, minibatch_per_gpu=8, force_dataset_args=dict(shuffle=False, max_images=None, repeat=False, mirror_augment=False)), 
